...
public class JsonUtils {
  ...
  /**
   * Translate a set of strings to a JSON array, optionally preserving the empty array. Otherwise
   * (default) empty array is returned as null.
   * 
   * @param value
   * @param preserveEmpty
   * @return
  ...
  public static PKCEAlgorithm getAsPkceAlgorithm(JsonObject o, String member) {
    String s = getAsString(o, member);
    return s != null ? PKCEAlgorithm.valueOf(s) : null;
  }
