...
public class TestMITREidDataService_1_2 {
	...
	public void testImportRefreshTokens() throws IOException, ParseException {
		...
		lenient().when(authHolderRepository.getById(null)).thenAnswer(new Answer<AuthenticationHolderEntity>() {
			Long id = 131L;
			@Override
	...
	public void testImportGrants() throws IOException, ParseException {
		...
		lenient().when(wlSiteRepository.getById(null)).thenAnswer(new Answer<WhitelistedSite>() {
			Long id = 432L;
			@Override
			public WhitelistedSite answer(InvocationOnMock invocation) throws Throwable {
		...
		lenient().when(tokenRepository.getAccessTokenById(null)).thenAnswer(new Answer<OAuth2AccessTokenEntity>() {
			Long id = 245L;
			@Override
			public OAuth2AccessTokenEntity answer(InvocationOnMock invocation) throws Throwable {
